...
\abstract{This paper focuses on three issues concerning headedness vs.\ grammatical anarchy
  in German prosody. 1) Language contact: Poetic metres which are designed without metrical heads cannot be
  transferred to German without heads. 2) Language change and syntactic structure: German(ic)
  anacruses are `headless' structures in terms of prosody – but the result of subsystem
