...
\item The Early Modern High German\il{German!Early Modern High} preposition \emph{von wegen} must come with a complement and a host clause, while the present-day \ili{German} interjection \emph{von wégen} is inherently independent of both (cf.\ the examples in Setion~\ref{sec-pres-vw}).
