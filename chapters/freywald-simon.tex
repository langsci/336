...
Surprisingly then, the \ili{Low German} verbs \emph{nickköppen}, \emph{schüddköppen/schürrköppen},
...
\ex
\gll nick-köpp-en\\
     nod-head-\textsc{inf} \\\hfill(\ili{Low German}, \citealt[50--52]{AsdahlHolmberg1973})\\
...
*\emph{oren} etc. do not exist in \ili{Low German}, at least not with the meanings involved in the
examples above.

The pattern is not exclusive for \ili{Low German}, it is also vividly present – and productive up to this
...
examples).\footnote{To the best of our knowledge, this kind of verb formation is, however, entirely
  absent from \ili{High German} varieties.} There are not many analyses of these verbs on the market, and
...
\item Noun incorporation (\citealt{vanGinneken1939}; \citealt{Weggelaar1986} for \ili{Dutch}):\footnote{We are very grateful to Anne Breitbarth for bringing the paper by Weggelaar to our attention.}
...
\gll Stuuten-botter     vs.     Botter-stuuten\\
     white.bread-butter {}  butter-white.bread\\\hfill(\ili{Low German})
...
\gll   Katt-eik   vs.   Eik-katt\\
       cat-oak    {}   oak-cat \\\hfill(\ili{Low German})
\glt   `squirrel'
\z
...
\ea
\label{bkm:Ref107850266}%\ili{German}\\
...
*freu-freu*        Der erste Award hat  meinen Blog  erreicht :)))    rejoice-rejoice   the  first award   has  my       blog   reached\footnote{Newsgroup and forum corpus, \citew{Richling2008}.} \\
...
\ili{Swiss German}. \Citet[22]{vanRiemsdijk2012} argued that the utterances in (\ref{bkm:Ref106561895})
...
\gll wil           si    het    müese    i    d     schuel   [GAA]\\
       because   she  had  have.to  in   the  school  go\\\hfill(\ili{Swiss German})
...
% ok
%\nocite{chapters/lander,chapters/salzmann,chapters/mueller,chapters/demske,chapters/korth,chapters/haider,chapters/buecker,chapters/nolda}

% nicht ok
%\nocite{chapters/lander,chapters/salzmann,chapters/mueller,chapters/demske,chapters/korth,chapters/haider,chapters/buecker,chapters/nolda}

% ok
%\nocite{chapters/lander,chapters/salzmann,chapters/mueller,chapters/demske,chapters/korth,chapters/haider,chapters/raffelsiefen}

%,chapters/salzmann,chapters/mueller,chapters/demske,chapters/korth,chapters/haider,chapters/raffelsiefen,chapters/noel,chapters/buecker,chapters/nolda}
