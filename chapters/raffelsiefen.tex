...
\author{Renate Raffelsiefen\orcid{0000-0002-9513-9798}\affiliation{Leibniz-Institut für Deutsche Sprache}}
...
\noindent
Satisfaction of both constraints in (\ref{ex-align17}) is demonstrated by the German words in Figure~\ref{w-head}. Words with only schwa as in Figures~\ref{ex-tee-align},~\ref{ex-tee-schwa} violate either head alignment or the ban on schwa in head syllables. Words containing no vowel other than schwa are thereby ruled out. 
...
\noemph{Fǘrstbischof} `Prince Bishop' (\noemph{Fürst} `prince', \noemph{Bischof} `bishop') \\
...
\noemph{Baden-Wǘrttemberg} (two names of territories associated with a single German state)\\
...
\ex {Mǘrb[ə]teig} \jambox{cf.\ (der) mürb[ə] Teig}
...
\ex \{\textbf{Loch}, Löcher\} \jambox{Fǘnf\textbf{loch}felge}
...
\ex \{\textbf{Korn}, Körner\} \jambox{Fǘnf\textbf{korn}brot}
